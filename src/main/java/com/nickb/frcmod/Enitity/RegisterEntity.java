...
public class RegisterEntity{
        ...
        public static void init() {
            ...
            int id = 1;
            EntityRegistry.registerModEntity(null,Deanmod.class, "Dean_kamen", id++, main.instance, 64, 3, true, 0x996600, 0x00ff00);
        ...
        public static void initModels() {
            RenderingRegistry.registerEntityRenderingHandler(Deanmod.class,Deanmod.FACTORY);
        }
}